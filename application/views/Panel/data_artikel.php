...
<div class="col-md-12">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <button class="btn btn-success" onclick="add_artikel();"></i> Tambah Data</button>
      </div>
      <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" class="form-control" name="idartikel"/> 
                    <div class="form-body">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo base_url('Artikel/ajax_list')?>",
                    "type": "POST"
                },
            ...
            $('.dropify').dropify({
                messages: {
                            default: '<h6>Pilih File. Anda juga bisa drag file kesini<br>File berupa JPG dan PNG</h6>',
                            replace: 'Ganti',
                            remove:  'Hapus',
                            error:   'error'
                           }
        ...
        function edit_artikel(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('Artikel/ajax_edit/')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    if(data.gambar)
                    {
                        ...
                        $('#photo-preview div').html('File lama: <img src="'+base_url+'assets/upload/'+data.gambar+'" id="imgold"  alt="" width="750"><input type="hidden" name="fileold" class="form-control" value="' + data.gambar + '">'); 
                       // remove photo
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('Artikel/ajax_add')?>";
            } else {
                url = "<?php echo site_url('Artikel/ajax_update')?>";
            }
        ...
        function delete_artikel(id)
        {
            if(confirm('Are you sure delete this data?'))
            {
                ...
                $.ajax({
                    url : "<?php echo site_url('Artikel/ajax_delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
