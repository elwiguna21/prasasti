...
<div class="col-md-12">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <button class="btn btn-success" onclick="add_galeri();"></i> Tambah Data</button>
      </div>
      <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">galeri Form</h3>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo base_url('Galeri/ajax_list')?>",
                    "type": "POST"
                },
        ...
        function add_galeri()
        {
            ...
            $('.modal-title').text('Add galeri'); // Set Title to Bootstrap modal title
        }
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    if(data.file)
                    {
                        ...
                        $('#photo-preview div').html('File lama: <img src="'+base_url+'assets/upload/'+data.file+'" id="imgold"  alt="" width="750"><input type="hidden" name="fileold" class="form-control" value="' + data.file + '">'); 
                       // remove photo
        ...
        function delete_galeri(id)
        {
            if(confirm('Are you sure delete this data?'))
            {
                ...
                $.ajax({
                    url : "<?php echo site_url('Galeri/ajax_delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
