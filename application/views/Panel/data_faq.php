...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Data FAQ</h1>
...
<div class="col-md-12">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <button class="btn btn-success" onclick="add_faq();"></i> Tambah Data</button>
      </div>
      <div class="card-body">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="pertanyaan" rows="10"></textarea>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo base_url('Faq/ajax_list')?>",
                    "type": "POST"
                },
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('Faq/ajax_add')?>";
            } else {
                url = "<?php echo site_url('Faq/ajax_update')?>";
            }
        ...
        function delete_faq(id)
        {
            if(confirm('Are you sure delete this data?'))
            {
                ...
                $.ajax({
                    url : "<?php echo site_url('Faq/ajax_delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
