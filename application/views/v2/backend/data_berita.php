          ...
          <div class="col-12">
               <div class="card">
                    <div class="card-header">
                         ...
                         <button class="btn btn-primary btn-sm" onclick="add_berita()"><i class="fas fa-plus me-1"></i> Tambah Data</button>
                    </div>
                    <div class="card-body">
               ...
               <div class="modal-body">
                    <form action="#" id="form" class="form-horizontal">
                         ...
                         <div class="mb-3">
                              ...
                              <textarea name="isi" class="form-control" rows="6" placeholder="Masukkan isi berita"></textarea>
                              <span class="help-block text-danger"></span>
                         </div>
...
function edit_berita(id) {
     ...
     $.ajax({
          url: "<?php echo site_url('v2/backend/beritas/ajax_edit/') ?>" + id,
          type: "GET",
          dataType: "JSON",
...
function save() {
     ...
     var url = (save_method == 'add') ? "<?php echo site_url('v2/backend/beritas/ajax_add') ?>" : "<?php echo site_url('v2/backend/beritas/ajax_update') ?>";
...
function delete_berita(id) {
     Swal.fire({
          ...
          if (result.isConfirmed) {
               $.ajax({ url: "<?php echo site_url('v2/backend/beritas/ajax_delete/') ?>" + id, type: "POST", dataType: "JSON",
