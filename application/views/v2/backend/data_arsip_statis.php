...
<div class="page-titles">
     <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Daftar Arsip Statis</li>
     </ol>
</div>
          ...
          <div class="col-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title">Daftar Arsip Statis</h4>
     ...
     <div class="modal-dialog modal-lg">
          <div class="modal-content">
               <div class="modal-header">
                    <h5 class="modal-title">Daftar Arsip Statis Form</h5>
...
$(document).ready(function() {
     table = $('#dataTable').DataTable({
          ...
          "ajax": { "url": "<?php echo base_url('v2/backend/arsipstatiss/ajax_list') ?>", "type": "POST" },
...
function add_data() {
     ...
     var myModal = new bootstrap.Modal(document.getElementById('modal_form')); myModal.show(); $('.modal-title').text('Tambah Arsip Statis');
...
function edit_data(id) {
     ...
     $.ajax({
          url: "<?php echo site_url('v2/backend/arsipstatiss/ajax_edit/') ?>" + id, type: "GET", dataType: "JSON",
          success: function(data) {
               ...
               var myModal = new bootstrap.Modal(document.getElementById('modal_form')); myModal.show(); $('.modal-title').text('Edit Arsip Statis');
          },
...
function save() {
     ...
     var url = (save_method == 'add') ? "<?php echo site_url('v2/backend/arsipstatiss/ajax_add') ?>" : "<?php echo site_url('v2/backend/arsipstatiss/ajax_update') ?>";
...
function delete_data(id) {
     Swal.fire({
          ...
          if (result.isConfirmed) {
               $.ajax({ url: "<?php echo site_url('v2/backend/arsipstatiss/ajax_delete/') ?>" + id, type: "POST", dataType: "JSON",
