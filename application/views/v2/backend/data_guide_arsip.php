          ...
          <div class="col-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title">Guide Arsip</h4>
     ...
     <div class="modal-dialog modal-lg">
          <div class="modal-content">
               <div class="modal-header">
                    <h5 class="modal-title">Guide Arsip Form</h5>
...
$(document).ready(function() {
     table = $('#dataTable').DataTable({
          ...
          "ajax": { "url": "<?php echo base_url('v2/backend/guidearsips/ajax_list') ?>", "type": "POST" },
...
function add_data() {
     ...
     var myModal = new bootstrap.Modal(document.getElementById('modal_form')); myModal.show(); $('.modal-title').text('Tambah Guide Arsip');
...
function edit_data(id) {
     ...
     $.ajax({
          url: "<?php echo site_url('v2/backend/guidearsips/ajax_edit/') ?>" + id, type: "GET", dataType: "JSON",
          success: function(data) {
               ...
               var myModal = new bootstrap.Modal(document.getElementById('modal_form')); myModal.show(); $('.modal-title').text('Edit Guide Arsip');
          },
...
function delete_data(id) {
     Swal.fire({
          ...
          if (result.isConfirmed) {
               $.ajax({ url: "<?php echo site_url('v2/backend/guidearsips/ajax_delete/') ?>" + id, type: "POST", dataType: "JSON",
