...
<div class="page-titles">
     <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inventaris Arsip</li>
     </ol>
</div>
          ...
          <div class="col-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title">Inventaris Arsip</h4>
                         <button class="btn btn-primary btn-sm" onclick="add_data()"><i class="fas fa-plus me-1"></i> Tambah Data</button>
                    </div>
                    <div class="card-body">
     ...
     <div class="modal-dialog modal-lg">
          <div class="modal-content">
               <div class="modal-header">
                    <h5 class="modal-title">Inventaris Arsip Form</h5>
...
$(document).ready(function() {
     table = $('#dataTable').DataTable({
          ...
          "ajax": { "url": "<?php echo base_url('v2/backend/inventarisarsips/ajax_list') ?>", "type": "POST" },
...
function add_data() {
     ...
     var myModal = new bootstrap.Modal(document.getElementById('modal_form')); myModal.show(); $('.modal-title').text('Tambah Inventaris Arsip');
...
function edit_data(id) {
     ...
     $.ajax({
          url: "<?php echo site_url('v2/backend/inventarisarsips/ajax_edit/') ?>" + id, type: "GET", dataType: "JSON",
          success: function(data) {
               ...
               var myModal = new bootstrap.Modal(document.getElementById('modal_form')); myModal.show(); $('.modal-title').text('Edit Inventaris Arsip');
          },
...
function save() {
     ...
     var url = (save_method == 'add') ? "<?php echo site_url('v2/backend/inventarisarsips/ajax_add') ?>" : "<?php echo site_url('v2/backend/inventarisarsips/ajax_update') ?>";
...
function delete_data(id) {
     Swal.fire({
          ...
          if (result.isConfirmed) {
               $.ajax({ url: "<?php echo site_url('v2/backend/inventarisarsips/ajax_delete/') ?>" + id, type: "POST", dataType: "JSON",
