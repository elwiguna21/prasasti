...
<div class="row page-titles">
     <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('v2/backend/alih_media_arsip_vital') ?>">Daftar Arsip Vital</a></li>
                         ...
                         <div class="tab-content">
                              ...
                              <div id="step-1" class="tab-pane" role="tabpanel">
                                   <div class="py-3">
                                        ...
                                        <p class="text-center text-muted small mb-4">Isi informasi berkas arsip vital</p>
                                   </div>
                                   <div class="row g-3">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                             <label class="form-label fw-semibold">Indeks <span class="text-danger">*</span></label>
                                             <input type="text" id="indeks" name="indeks" class="form-control" placeholder="Masukan indeks arsip">
                                             <span class="help-block text-danger small"></span>
                                        </div>
                                        <div class="col-12">
...
<script>
     ...
     $('#btnSimpan').click(function() {
          ...
          if (!validateStep2()) {
               Swal.fire({
                    title: "Kesalahan",
                    text: "Mohon upload dokumen arsip terlebih dahulu (Step 2).",
                    icon: "warning",
                    allowOutsideClick: false,
                    allowEscapeKey: false,
               });
