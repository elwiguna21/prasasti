                                        ...
                                        <li>
                                             <div class="timeline-panel">
                                                  ...
                                                  <div class="media-body">
                                                       ...
                                                       <small class="d-block"><?= tgl_indo(date('Y-m-d', strtotime($archieve->created_at))) ?></small>
                                                  </div>
                                             </div>
                                        </li>
                                                  ...
                                                  <div class="timeline-panel">
                                                       ...
                                                       <div class="media-body">
                                                            ...
                                                            <?php } else if ($archieve->tte_status == 'R') { ?>
                                                                 <small class="d-block">Ditolak oleh</small>
                                                            <?php } ?>
                                                            <?php if (!empty($archieve->tte_user) && !empty($archieve->signer)) { ?>
                                                                 <h6 class="mb-1"><?= $archieve->signer->fullname; ?></h6>
                                                            <?php } else { ?>
                                                                 <h6 class="mb-1"><?= $archieve->tte_message; ?></h6>
                                                            <?php }
                                                            ?>
                                                            <small class="d-block"><?= (!empty($archieve->tte_tanggal)) ? tgl_indo(date('Y-m-d', strtotime($archieve->tte_tanggal))) : '-'; ?></small>
                                                       </div>
                                                  </div>
                                             </li>
...
<script>
     (function() {
          ...
          var ttePosisi = null;
          const ttePosisiRaw = '<?php echo $ttePosisi; ?>';

          // 2. Check for null, empty strings, or stringified "null"
          if (ttePosisiRaw && ttePosisiRaw !== "" && ttePosisiRaw !== "null") {
               try {
                    ttePosisi = JSON.parse(ttePosisiRaw);
               } catch (error) {
