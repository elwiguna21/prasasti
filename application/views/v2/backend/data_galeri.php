               ...
               <div class="modal-body">
                    <form action="#" id="form" class="form-horizontal">
                         ...
                         <div class="mb-3">
                              ...
                              <textarea name="ref_link" class="form-control" placeholder="Masukkan link eksternal"></textarea>
                         </div>
...
<script type="text/javascript">
     ...
     table = $('#dataTable').DataTable({
          ...
          "order": [1, 'asc'],
          "ajax": {
               "url": "<?php echo base_url('v2/galleries/ajax_list') ?>",
               "type": "POST"
          },
          "columnDefs": [{
               "targets": [-1],
     ...
     function edit_galeri(id) {
          ...
          $('.help-block').empty();
          $.ajax({
               url: "<?php echo site_url('v2/galleries/ajax_edit/') ?>" + id,
               type: "GET",
               dataType: "JSON",
               success: function(data) {
                    $('[name="id"]').val(data.id);
                    $('[name="judul"]').val(data.caption);
                    $('[name="ref_link"]').val(data.ref_link);
                    if (data.file) {
