...
<div class="form-head d-flex mb-3 align-items-start">
     <div class="me-auto d-block">
          ...
          <p class="mb-0">Selamat datang di Dashboard Prasasti! Berikut ringkasan data seluruh sistem.</p>
     </div>
</div>

<!-- Row 1: Statistik Pengunjung Website -->
<div class="row">
               ...
               <div class="card-body p-4">
                    <div class="media ai-icon d-flex">
                         <span class="me-3 bgl-white text-white">
                              <i class="ti-calendar" style="font-size: 30px"></i>
                         </span>
     ...
     <div class="col-xl-4 col-xxl-4 col-lg-4 col-md-4 col-sm-12">
          <div class="widget-stat card bg-success">
               <div class="card-body p-4">
                    <div class="media ai-icon d-flex">
                         <span class="me-3 bgl-white text-white">
                              <i class="ti-bar-chart" style="font-size: 30px"></i>
                         </span>
                         <div class="media-body text-white">
          ...
          <div class="widget-stat card">
               <div class="card-body p-4">
                    <div class="media ai-icon d-flex">
                         ...
                         <div class="media-body">
                              <h3 class="mb-0 text-black"><span class="counter ms-0"><?= $total_skpd; ?></span></h3>
                              <p class="mb-0">Total SKPD</p>
                         </div>
                    </div>
               </div>
          </div>
...
<div class="row">
                         ...
                         <div class="media-body text-white">
                              ...
                              <div class="progress mb-2 bg-primary">
                                   <div class="progress-bar progress-animated bg-white"
                                        style="width: <?= ($total_archieves > 0 && $total_archieves_inactives > 0) ? ($total_archieves_inactives / $total_archieves) * 100 : 0; ?>%"></div>
                              </div>
                              <small><?= ($total_archieves > 0 && $total_archieves_inactives > 0) ? round(($total_archieves_inactives / $total_archieves) * 100, 2) : 0; ?>
                    ...
                    <div class="media">
                         ...
                         <div class="media-body text-white">
                              ...
                              <div class="progress mb-2 bg-success">
                                   <div class="progress-bar progress-animated bg-white"
                                        style="width: <?= ($total_archieves > 0 && $total_archieves_vital > 0) ? ($total_archieves_vital / $total_archieves) * 100 : 0; ?>%"></div>
                              </div>
                              <small><?= ($total_archieves > 0 && $total_archieves_vital > 0) ?  round(($total_archieves_vital / $total_archieves) * 100, 2) : 0; ?>
                                   % dari total arsip</small>
                         </div>
                    </div>
               </div>
               ...
               <div class="card-body p-4">
                    <div class="media">
                         ...
                         <div class="media-body text-white">
                              ...
                              <div class="progress mb-2 bg-secondary">
                                   <div class="progress-bar progress-animated bg-white"
                                        style="width: <?= ($total_archieves > 0 && $total_archieves_usul_musnah > 0) ? ($total_archieves_usul_musnah / $total_archieves) * 100 : 0; ?>%"></div>
                              </div>
                              <small><?= ($total_archieves > 0 && $total_archieves_usul_musnah > 0) ? round(($total_archieves_usul_musnah / $total_archieves) * 100, 2) : 0; ?>
                                   % dari total arsip</small>
                         </div>
                    </div>
               </div>
     ...
     <!-- Row 4: Chart Arsip Dibuat + Log Pengguna -->
     <div class="col-xl-8 col-xxl-8 col-lg-12 col-sm-12">
          <div class="card">
               <div class="card-header border-0 pb-0 d-sm-flex d-block">
                    <div class="me-3">
                         <h4 class="card-title mb-1">Arsip Dibuat</h4>
                         <small class="mb-0">Total arsip yang dibuat berdasarkan bulan (seluruh SKPD)</small>
                    </div>
                              ...
                              <div class="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9">
                                   <div class="d-flex align-items-center mb-3">
                                        <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Menunggu Verifikasi
                                             (<?= ($total_archieves_vital > 0 && $total_archieve_vital_waiting_verification > 0) ? number_format(($total_archieve_vital_waiting_verification / $total_archieves_vital) * 100, 2, ',', '.') : 0 ?>
                                             %)</p>
                                        <div class="progress mb-0" style="height:8px; width:100%;">
                                             <div class="progress-bar bg-primary progress-animated"
                                                  style="width:<?= ($total_archieves_vital > 0 && $total_archieve_vital_waiting_verification > 0) ? number_format(($total_archieve_vital_waiting_verification / $total_archieves_vital) * 100, 2, ',', '.') : 0 ?>%; height:8px;"
                                                  role="progressbar">
                                   ...
                                   <div class="d-flex align-items-center  mb-3">
                                        <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Menunggu di TTE
                                             (<?= ($total_archieves_vital > 0 && $total_archieve_vital_waiting_signed > 0) ? number_format(($total_archieve_vital_waiting_signed / $total_archieves_vital) * 100, 2, ',', '.') : 0 ?>
                                             %)</p>
                                        <div class="progress mb-0" style="height:8px; width:100%;">
                                             <div class="progress-bar bg-warning progress-animated"
                                                  style="width:<?= ($total_archieves_vital > 0 && $total_archieve_vital_waiting_signed > 0) ? ($total_archieve_vital_waiting_signed / $total_archieves_vital) * 100 : 0 ?>%; height:8px;"
                                                  role="progressbar">
                                                  <span class="sr-only">Complete</span>
                                             </div>
                                        </div>
                                   ...
                                   <div class="d-flex align-items-center">
                                        <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Selesai di TTE
                                             (<?= ($total_archieves_vital > 0 && $total_archieve_vital_signed > 0) ? number_format(($total_archieve_vital_signed / $total_archieves_vital) * 100, 2, ',', '.') : 0 ?>
                                             %)</p>
                                        <div class="progress mb-0" style="height:8px; width:100%;">
                                             <div class="progress-bar bg-success progress-animated"
                                                  style="width:<?= ($total_archieves_vital > 0 && $total_archieve_vital_signed > 0) ? ($total_archieve_vital_signed / $total_archieves_vital) * 100 : 0 ?>%; height:8px;"
                                                  role="progressbar">
                                                  <span class="sr-only">Complete</span>
                                             </div>
                                        </div>
          ...
          <div class="card">
               <div class="card-header border-0 pb-0 d-sm-flex flex-wrap d-block">
                    <div class="mb-3">
                         ...
                         <small class="mb-0">Arsip Usul Musnah berdasarkan status (seluruh SKPD)</small>
                    </div>
               </div>
               <div class="card-body tab-content orders-summary pt-3">
                    <div class="d-flex flex-wrap order-manage p-3 align-items-center mb-4">
                    ...
                    <div class="widget-timeline-icon">
                         <div class="row align-items-center">
                              ...
                              <div class="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9">
                                   <div class="d-flex align-items-center mb-3">
                                        <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Menunggu Verifikasi
                                             (<?= ($total_archieves_usul_musnah > 0 && $total_archieve_musnah_waiting_verification > 0) ? number_format(($total_archieve_musnah_waiting_verification / $total_archieves_usul_musnah) * 100, 2, ',', '.') : 0 ?>
                                             %)</p>
                                        <div class="progress mb-0" style="height:8px; width:100%;">
                                             <div class="progress-bar bg-primary progress-animated"
                                                  style="width:<?= ($total_archieves_usul_musnah > 0 && $total_archieve_musnah_waiting_verification > 0) ? ($total_archieve_musnah_waiting_verification / $total_archieves_usul_musnah) * 100 : 0 ?>%; height:8px;"
                                                  role="progressbar">
                                                  <span class="sr-only">Complete</span>
                                             </div>
                                        </div>
                                   ...
                                   <div class="d-flex align-items-center  mb-3">
                                        <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Menunggu di TTE
                                             (<?= ($total_archieves_usul_musnah > 0 && $total_archieve_musnah_waiting_signed > 0) ? number_format(($total_archieve_musnah_waiting_signed / $total_archieves_usul_musnah) * 100, 2, ',', '.') : 0 ?>
                                             %)</p>
                                        <div class="progress mb-0" style="height:8px; width:100%;">
                                             <div class="progress-bar bg-warning progress-animated"
                                                  style="width:<?= ($total_archieves_usul_musnah > 0 && $total_archieve_musnah_waiting_signed > 0) ? ($total_archieve_musnah_waiting_signed / $total_archieves_usul_musnah) * 100 : 0 ?>%; height:8px;"
                                                  role="progressbar">
                                                  <span class="sr-only">Complete</span>
                                             </div>
                                        </div>
                                   ...
                                   <div class="d-flex align-items-center">
                                        <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Selesai di TTE
                                             (<?= ($total_archieves_usul_musnah > 0 && $total_archieve_musnah_signed > 0) ? number_format(($total_archieve_musnah_signed / $total_archieves_usul_musnah) * 100, 2, ',', '.') : 0 ?>
                                             %)</p>
                                        <div class="progress mb-0" style="height:8px; width:100%;">
                                             <div class="progress-bar bg-success progress-animated"
                                                  style="width:<?= ($total_archieves_usul_musnah > 0 && $total_archieve_musnah_signed > 0) ? ($total_archieve_musnah_signed / $total_archieves_usul_musnah) * 100 : 0 ?>%; height:8px;"
                                                  role="progressbar">
                                                  <span class="sr-only">Complete</span>
                                             </div>
                                        </div>
     ...
     <!-- Row 6: Chart Arsip per SKPD (Khusus Admin) -->
     <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
          <div class="card">
               <div class="card-header border-0 pb-0 d-sm-flex d-block">
                    <div class="me-3">
                         <h4 class="card-title mb-1">Distribusi Arsip per SKPD</h4>
                         <small class="mb-0">Jumlah arsip yang tercatat pada setiap SKPD</small>
                    </div>
               </div>
...
<script>
     // ========== Donut Charts: Status Arsip Vital & Usul Musnah ==========
     ...
     // ========== Horizontal Bar Chart: Arsip per SKPD ==========
     <?php if (isset($archieve_per_skpd) && !empty($archieve_per_skpd['labels'])) { ?>
     var skpdOptions = {
          series: [{
               name: 'Jumlah Arsip',
               data: <?= json_encode($archieve_per_skpd['datasets']); ?>
          }],
          chart: {
               type: 'bar',
               height: Math.max(300, <?= count($archieve_per_skpd['labels']) ?> * 40),
               toolbar: {
                    show: false,
               },
          },
          ...
          colors: ['#2f4cdd', '#2bc155', '#ff6d4d', '#ffab2d', '#5bcfc5', '#f44336', '#9c27b0', '#00bcd4', '#8bc34a', '#ff9800'],
          dataLabels: {
               enabled: true,
               style: {
                    fontSize: '12px',
          ...
          xaxis: {
               categories: <?= json_encode($archieve_per_skpd['labels']); ?>,
               labels: {
                    style: {
                         colors: '#3e4954',
                         fontSize: '12px',
     ...
     var skpdChart = new ApexCharts(document.querySelector("#skpd-chart"), skpdOptions);
     skpdChart.render();
     <?php } else { ?>
     document.querySelector("#skpd-chart").innerHTML = '<div class="alert alert-info text-center mb-0"><i class="fa fa-info-circle me-2"></i>Belum ada data arsip per SKPD yang tersedia.</div>';
     <?php } ?>
</script>
