     ...
     <div class="col-12">
          <div class="card">
               <div class="card-header">
                    ...
                    <button class="btn btn-primary btn-sm" onclick="add_peraturan()"><i class="fas fa-plus me-1"></i>
                         Tambah Data
                    </button>
               </div>
               <div class="card-body">
...
<script type="text/javascript">
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {"url": "<?php echo base_url('v2/regulations/ajax_list') ?>", "type": "POST"},
    ...
    function add_peraturan() {
        ...
        myModal.show();
        $('.modal-title').text('Tambah Peraturan');
    ...
    function edit_peraturan(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('v2/regulations/ajax_edit/') ?>" + id, type: "GET", dataType: "JSON",
            success: function (data) {
                ...
                var myModal = new bootstrap.Modal(document.getElementById('modal_form'));
                myModal.show();
                $('.modal-title').text('Edit Peraturan');
            },
            error: function () {
    ...
    function save() {
        ...
        var url = (save_method == 'add') ? "<?php echo site_url('v2/regulations/ajax_add') ?>" : "<?php echo site_url('v2/regulations/ajax_update') ?>";
    ...
    function delete_peraturan(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('v2/regulations/ajax_delete/') ?>" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function () {
