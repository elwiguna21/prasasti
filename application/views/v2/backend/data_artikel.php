     ...
     <div class="col-12">
          <div class="card">
               <div class="card-header">
                    ...
                    <button class="btn btn-primary btn-sm" onclick="add_artikel()"><i class="fas fa-plus me-1"></i>
                         Tambah Data
                    </button>
               </div>
               <div class="card-body">
...
<script type="text/javascript">
    ...
    table = $('#dataTable').DataTable({
        ...
        "order": [2, 'asc'],
        "ajax": {
            "url": "<?php echo base_url('v2/articles/list/ajax') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
    ...
    function edit_artikel(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('v2/articles/manage/edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save() {
        ...
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('v2/articles/manage/add') ?>";
        } else {
            url = "<?php echo site_url('v2/articles/manage/update') ?>";
        }
    ...
    function delete_artikel(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('v2/articles/manage/delete/') ?>" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function (data) {
