     ...
     <div class="col-12">
          <div class="card">
               <div class="card-header">
                    ...
                    <button class="btn btn-primary btn-sm" onclick="add_profil()"><i class="fas fa-plus me-1"></i> Tambah Profil</button>
               </div>
               <div class="card-body">
                    ...
                    <form action="#" id="form" class="form-horizontal">
                         ...
                         <div class="row">
                              <div class="col-md-6 mb-3">
                                   ...
                                   <textarea name="visi" class="form-control" rows="4" placeholder="Visi organisasi"></textarea>
                                   <span class="help-block text-danger"></span>
                              </div>
                              <div class="col-md-6 mb-3">
                                   <label class="form-label">Misi</label>
                                   <textarea name="misi" class="form-control" rows="4" placeholder="Misi organisasi"></textarea>
                                   <span class="help-block text-danger"></span>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <div class="col-md-6 mb-3">
                                   ...
                                   <textarea name="sambutan" class="form-control" rows="4" placeholder="Kata sambutan"></textarea>
                                   <span class="help-block text-danger"></span>
                              </div>
                              <div class="col-md-6 mb-3">
                                   <label class="form-label">Gambaran Umum</label>
                                   <textarea name="gambaran_umum" class="form-control" rows="4" placeholder="Gambaran umum organisasi"></textarea>
                                   <span class="help-block text-danger"></span>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <div class="col-md-6 mb-3">
                                   ...
                                   <textarea name="tugas_fungsi" class="form-control" rows="4" placeholder="Tugas dan fungsi"></textarea>
                                   <span class="help-block text-danger"></span>
                              </div>
                              <div class="col-md-6 mb-3">
                                   <label class="form-label">Sejarah</label>
                                   <textarea name="sejarah" class="form-control" rows="4" placeholder="Sejarah organisasi"></textarea>
                                   <span class="help-block text-danger"></span>
                              </div>
                         </div>
                         ...
                         <div class="mb-3">
                              ...
                              <textarea name="struktur_organisasi" class="form-control" rows="3" placeholder="Deskripsi struktur organisasi"></textarea>
                              <span class="help-block text-danger"></span>
                         </div>
                         ...
                         <div class="mb-3">
                              ...
                              <input type="file" class="form-control dropify" name="file_struktur_organisasi" data-height="150" data-allowed-file-extensions="jpg png jpeg">
                              <span class="help-block text-danger"></span>
                         </div>
...
$(document).ready(function() {
     ...
     table = $('#dataTable').DataTable({
          ...
          "order": [],
          "ajax": {
               "url": "<?php echo base_url('v2/backend/profils/ajax_list') ?>",
               "type": "POST"
          },
          "columnDefs": [{
               "targets": [-1],
...
function edit_profil(id) {
     ...
     $.ajax({
          url: "<?php echo site_url('v2/backend/profils/ajax_edit/') ?>" + id,
          type: "GET",
          dataType: "JSON",
...
function save() {
     ...
     if (save_method == 'add') {
          url = "<?php echo site_url('v2/backend/profils/ajax_add') ?>";
     } else {
          url = "<?php echo site_url('v2/backend/profils/ajax_update') ?>";
     }
...
function delete_profil(id) {
     Swal.fire({
          ...
          if (result.isConfirmed) {
               $.ajax({
                    url: "<?php echo site_url('v2/backend/profils/ajax_delete/') ?>" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
                         Swal.fire(
