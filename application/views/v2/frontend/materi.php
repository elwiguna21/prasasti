...
<style>
     ...
     .dt-paging .pagination .page-item .page-link {
          ...
          margin: 0 4px;
          /* Adds space between rounded buttons */
     }
...
<div class="breadcrumb-section bg-img"
     ...
     <div class="container">
          ...
          <div class="breadcrumb-content">
               ...
               <h2>Materi / Paparan</h2>
               <ul class="list-unstyled">
                    <li><a href="<?= base_url() ?>">Beranda</a></li>
                    <li>Materi / Paparan</li>
               </ul>
          </div>
     </div>
          ...
          <div class="row justify-content-center">
               ...
               <div class="col-12 col-md-7">
                    <div class="section-heading text-center">
                         <span class="sub-title">Materi / Paparan</span>
                         <p class="mb-0">Daftar materi / paparan terkait arsip di lingkungan Pemerintah Daerah
          ...
          <div class="row">
               <div class="col-12">
                    <div class="table-responsive">
                         <table class="table table-hover table-bordered" id="materi-table">
                              <thead class="">
                                   <tr>
                                        <th width="10%" class="text-center">No.</th>
                                        <th>Judul Materi / Paparan</th>
...
<script>
     let materi_table = $('#materi-table').DataTable({
          responsive: false,
          searching: true,
          processing: true,
          serverSide: true,
          ...
          language: {
               ...
               searchPlaceholder: 'Cari nama materi / paparan ...',
               sSearch: '',
               paginate: {
