<div class="dlab-bnr-inr overlay-primary bg-pt" style="background-image:url(<?= base_url('assets/v3/frontend/') ?>images/banner/bnr7.jpg);">
     <div class="container">
          <div class="dlab-bnr-inr-entry">
               <h1 class="text-white"><?= $article->judul; ?></h1>
               <!-- Breadcrumb row -->
          ...
          <div class="row justify-content-center">
               ...
               <div class="col-lg-8 col-12">
                    ...
                    <div class="blog-post blog-single">
                         <div class="dlab-post-media dlab-img-effect zoom-slow wow fadeIn m-b10" data-wow-delay="0.2s"> <a href="javascript:void(0);"><img src="<?= $article->gambar; ?>" alt=""></a> </div>
                         ...
                         <div class="dlab-post-text">
                              <p class="text-justify"><?= $article->isi; ?></p>
                         </div>
