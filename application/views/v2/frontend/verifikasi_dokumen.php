            ...
            <?php else: ?>
                ...
                <?php if (!empty($berkas->tte_status) && $berkas->tte_status === 'Y'): ?>
                    <div class="alert alert-success d-flex align-items-center shadow-sm border-0" role="alert">
                        ...
                        <div>
                            ...
                            <small>Dokumen ini telah ditandatangani secara elektronik dan terverifikasi.</small>
                        </div>
                    </div>
                <?php else: ?>
                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold"><?= htmlspecialchars($berkas->jumlah ?? '-') ?> dok</td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold"><?= !empty($berkas->tte_tanggal) ? date('d F Y, H:i', strtotime($berkas->tte_tanggal)) : '-' ?> WIB</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card border-0 shadow mt-3 bg-light">
                    <div class="card-body small text-muted">
                        ...
                        <p class="mb-0">- Dokumen ini telah ditandatangani secara elektronik menggunakan sertifikat elektronik yang diterbitkan oleh Balai Besar Sertifikasi Elektronik (BSrE), Badan Siber dan Sandi Negara.</p>
                    </div>
                </div>
