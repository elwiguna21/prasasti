          ...
          <div class="row g-5 g-md-4 g-lg-5">
               <div class="col-12 col-lg-7">
                    <div class="portfolio-details-content">
                         <!--                         <h2 class="fw-semibold display-5">Responsive Websites for Accessibility</h2>-->
                         <div class="row">
<!--                              <div class="col-lg-6 col-12 mb-3">-->
<!--                                   <div class="d-flex align-items-start gap-4">-->
<!--                                        <div class="icon">-->
<!--                                             <i class="ti ti-calendar-month text-blue" style="font-size: 30px"></i>-->
<!--                                        </div>-->
<!--                                        <div>-->
<!--                                             <h6 class="mb-1">TAHUN</h6>-->
<!--                                             <p class="mb-0">--><?php //= $archieve->tahun; ?><!--</p>-->
<!--                                        </div>-->
<!--                                   </div>-->
<!--                              </div>-->
<!--                              <div class="col-lg-6 col-12 mb-3">-->
<!--                                   <div class="d-flex align-items-start gap-4">-->
<!--                                        <div class="icon">-->
<!--                                             <i class="ti ti-user-edit text-blue" style="font-size: 30px;"></i>-->
<!--                                        </div>-->
<!--                                        <div>-->
<!--                                             <h6 class="mb-1">SKPD</h6>-->
<!--                                             <p class="mb-0">--><?php //= $archieve->name; ?><!--</p>-->
<!--                                        </div>-->
<!--                                   </div>-->
<!--                              </div>-->
...
<!--                                   <div class="d-flex align-items-start gap-4">-->
<!--                                        <div class="icon">-->
<!--                                             <i class="ti ti-file-info text-blue" style="font-size: 30px;"></i>-->
<!--                                        </div>-->
<!--                                        <div>-->
<!--                                             <h6 class="mb-1">URAIAN INFORMASI ARSIP</h6>-->
<!--                                             <p class="mb-0">--><?php //= nl2br($archieve->uraian_informasi_arsip); ?><!--</p>-->
<!--                                        </div>-->
<!--                                   </div>-->
<!--                              </div>-->
							...
							<?php if ($archieve->tte_status == 'Y' and file_exists('./assets/upload/berkas/' . $archieve->tte_dokumen)) { ?>
                                        <h6 class="mb-1">Pratinjau Dokumen</h6>
                    ...
                    <div class="portfolio-sidebar">
                         ...
                         <div class="project-details-card">
                              ...
                              <div class="project-info mt-4">
                                   <!--                                   <div><span class="label">Jenis Arsip</span>: <span class="value">-->
							<?php //= $jenis_arsip; ?><!--</span>-->
                                   <!--                                   </div>-->
                                   <!--                                   <div class="align-middle"><span class="label">Unit Kerja Pencipta</span>: <span class="value">-->
							<?php //= $archieve->unit_kerja_pencipta; ?><!--</span>-->
                                   <!--                                   </div>-->
                                   <!---->
                                   <!--                                   <div><span class="label">Date</span>: <span class="value">20 January, 2023</span>-->
                                   <!--                                   </div>-->
