...
<!--                                                            <img alt="image" width="50" src="--><?php //= base_url('assets/v3/backend/') ?><!--images/avatar/1.jpg">-->
<!--                                                       </div>-->
...
<!--                         </li>-->
                         <li class="nav-item dropdown header-profile">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                   <a href="<?= base_url('v2/users/profiles') ?>" class="dropdown-item ai-icon <?= ($this->uri->segment(4) == 'profiles') ? 'active' : ''; ?>">
