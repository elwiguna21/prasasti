  ...
  <div class="col-xl-4 col-lg-5">
    <div class="card shadow mb-4">
      ...
      <div class="card-body text-center">     
       <h4 class="text-center"><?= $this->session->userdata('skpd')?></h4>
       <p>Operator : <?= $this->session->userdata('nama')?></p>
       <a href="Dashboard/akun/<?= $this->session->userdata('nomor_skpd')?>" class="btn btn-outline-dark btn-block">Edit Akun</a>
      </div>
    </div>
  </div>
</div>
