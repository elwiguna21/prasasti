  ...
  <div class="col-md-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <form class="form-horizontal" action="<?= base_url()?>Dashboard/akunupdate" method="post">
                <?php
                if($akun != null){
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_skpd" value="<?=$data->nama_skpd?>">
                </div>
                <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" class="form-control" name="alamat_skpd" value="<?= $data->alamat_skpd?>" >
                </div>
                <div class="form-group">
                  <label>Nama Operator</label>
                  <input type="text" class="form-control" name="nama_operator" value="<?= $data->nama_operator?>" >
                </div>
                <div class="form-group">
                  <label>Kontak Operator</label>
                  <input type="number" class="form-control" name="kontak_operator" value="<?= $data->kontak_operator?>">
                </div>
                <div class="form-group">
                  <label>Username</label>
                  <input type="text" class="form-control" name="username" value="<?= $data->username?>" >
                </div>
                <button class="btn btn-outline-success btn-block mt-4" type="submit" name="update">UBAH</button>
