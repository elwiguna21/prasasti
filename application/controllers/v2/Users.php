     ...
     public function deleted()
     {
          ...
          if ($user_id == $this->encryption->decrypt($employee->user_id) && $employee_id == $this->encryption->decrypt($employee->id)) {
               ...
               if ($deleted) {
                    ...
                    echo json_encode(array('status' => 500, 'message' => 'Pengguna gagal dihapus!'));
               }
          } else {
               echo json_encode(array('status' => 404, 'message' => 'Pengguna yang anda cari tidak ditemukan! Silahkan coba kembali.'));
          }
     }
}
