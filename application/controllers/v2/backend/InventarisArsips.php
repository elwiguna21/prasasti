...
class InventarisArsips extends MY_Controller
{
     public $user_auth;
     ...
     public function __construct()
     {
          ...
          $this->load->model('M_inventaris_arsip', 'inventaris_arsip');
     ...
     public function index()
     {
          ...
          $this->backend('v2/backend/data_inventaris_arsip', $data);
     }
     ...
     public function ajax_list()
     {
          ...
          $list  = $this->inventaris_arsip->get_datatables();
          $data  = array();
          $no    = $_POST['start'];
          $nomor = 1;
          ...
          $output = array(
               "draw"            => $_POST['draw'],
               "recordsTotal"    => $this->inventaris_arsip->count_all(),
               "recordsFiltered" => $this->inventaris_arsip->count_filtered(),
               "data"            => $data,
          );
     ...
     {
          $data = $this->inventaris_arsip->get_by_id($id);
     ...
     public function ajax_add()
     {
          ...
          if (!empty($_FILES['file']['name'])) {
               if ($this->upload->do_upload('file')) {
                    ...
                    $this->inventaris_arsip->save($data);
     ...
     public function ajax_update()
     {
          ...
          if (!empty($_FILES['file']['name'])) {
               if ($this->upload->do_upload('file')) {
                    ...
                    $gbr = $this->upload->data();
                    $data['file'] = $gbr['file_name'];
                    $this->inventaris_arsip->update($where, $data);
               }
          } else {
               $data['file'] = $fileold;
               $this->inventaris_arsip->update($where, $data);
