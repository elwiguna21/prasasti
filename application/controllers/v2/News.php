...
class News extends MY_Controller
{
     ...
     public function index()
     {
          ...
          $this->frontend_new('v2/frontend/news/index', $data);
     }
     ...
     public function detail()
     {
          ...
          $this->frontend_new('v2/frontend/news/detail', $data);
     }
     ...
     public function articles()
     {
          ...
          $this->frontend_new('v2/frontend/news/article', $data);
     }
     ...
     public function articles_detail()
     {
          ...
          if (file_exists('./assets/upload/' . $article->gambar)) {
               ...
               $article->gambar = base_url('assets/v3/frontend/v2/img/bg-img/117.jpg');
          }
          ...
          $this->frontend_new('v2/frontend/news/article_detail', $data);
     }
