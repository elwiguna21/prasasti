...
class Banners extends MY_Controller
{
     ...
     public function index()
     {
          ...
          $this->backend('v2/backend/data_banner', $data);
     }
     ...
     public function ajax_list()
     {
          ...
          foreach ($list as $banner) {
               ...
               $row[] = $nomor++;
               $row[] = $banner->caption;
               $row[] = '<div class="d-flex"><a class="btn btn-primary btn-xs sharp me-1" href="javascript:void(0)" title="Edit" onclick="edit_banner(\'' . $banner->id . '\')"><i class="fas fa-pencil-alt"></i></a><a class="btn btn-danger btn-xs sharp" href="javascript:void(0)" title="Hapus" onclick="delete_banner(\'' . $banner->id . '\')"><i class="fas fa-trash"></i></a></div>';
               $data[] = $row;
          }
