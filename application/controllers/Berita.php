...
class Berita extends CI_Controller {
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $berita) {
            ...
            //add html for action
            $row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_berita('."'".$berita->idberita."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_berita('."'".$berita->idberita."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
    ...
    public function ajax_update()
    {
        ...
        if(!empty($_FILES['file']['name']))
        {
            ...
            $insert = $this->berita->update($where,$data);
