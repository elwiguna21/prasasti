...
class Banner extends CI_Controller {
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $banner) {
            ...
            //add html for action
            $row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_banner('."'".$banner->id."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_banner('."'".$banner->id."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
    ...
    public function ajax_update()
    {
        ...
        if(!empty($_FILES['file']['name']))
        {
            ...
            $insert = $this->banner->update($where,$data);
