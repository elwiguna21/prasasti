...
class Peraturan extends CI_Controller {
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $peraturan) {
            ...
            //add html for action
            $row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_peraturan('."'".$peraturan->id."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                  <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_peraturan('."'".$peraturan->id."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
        ...
        $data = array(
            ...
            if(!empty($_FILES['file']['name']))
            {
                ...
                $data['file']=$gbr['file_name'];
                     ...
                     $insert = $this->peraturan->save($data);
    ...
    public function ajax_update()
    {
        ...
        if(!empty($_FILES['file']['name']))
        {
            ...
            $insert = $this->peraturan->update($where,$data);
