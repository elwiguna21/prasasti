...
$route['v2/backend/alih_media_arsip_usul_serah/export_excel']                   = 'v2/backend/AlihMediaArsipUsulSerahs/export_excel';
$route['v2/backend/alih_media_arsip_usul_serah/export_pdf']                     = 'v2/backend/AlihMediaArsipUsulSerahs/export_pdf';
...
$route['v2/backend/alih_media_arsip_usul_serah/ajax_verify_tte']                = 'v2/backend/AlihMediaArsipUsulSerahs/ajax_verify_tte';
...
$route['v2/alih_media_arsip_vital/inactive_deleted']                            = 'v2/archieves/inactive_deleted';
